...
### Windows
1. Download `Srotas.WhatsApp.Bot.Setup.1.2.6.exe`.
...
### macOS
1. Download `Srotas.WhatsApp.Bot-1.2.6-arm64.dmg` (Apple Silicon M1/M2/M3) or the universal `.dmg` / `.pkg`.
...
- Toggle **Auto-Reply ON** per device. The engine queries SQLite conversation memory to maintain multi-turn conversational context.
