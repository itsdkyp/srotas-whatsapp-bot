...
### Windows
1. Download `Srotas.WhatsApp.Bot.Setup.1.5.1.exe`.
...
### macOS
1. Download `Srotas.WhatsApp.Bot-1.5.1-arm64.dmg` (Apple Silicon M1/M2/M3) or the universal `.dmg` / `.pkg`.
